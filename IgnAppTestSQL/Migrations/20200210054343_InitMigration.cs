        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FKApplicationStatusId = table.Column<int>(nullable: true, defaultValueSql: "1"),
                    ApplicationStatusStatusId = table.Column<int>(nullable: true),
                    FkQuestionToAnswerId = table.Column<int>(nullable: false),
                    FkIgniteUserId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IgniteUserApplications_QuestionsToAnswers_FkQuestionToAnswerId",
                        column: x => x.FkQuestionToAnswerId,
                        principalTable: "QuestionsToAnswers",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IgniteUserId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PreQualificationQuestionFilled = table.Column<bool>(nullable: false),
                    HRApproved = table.Column<bool>(nullable: false),
                    StartDate = table.Column<DateTime>(nullable: false),
                    EligibleForQualification = table.Column<bool>(nullable: false, defaultValueSql: "0"),
                    FKDepartmentId = table.Column<int>(nullable: true, defaultValueSql: "2"),
                    FKTitleId = table.Column<int>(nullable: true, defaultValueSql: "14"),
                    FKLocationId = table.Column<int>(nullable: true, defaultValueSql: "0"),
                    FKBUID = table.Column<int>(nullable: true, defaultValueSql: "1")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Departments",
                columns: new[] { "DepartmentId", "DepartmentName", "IgniteUserId" },
                values: new object[,]
                {
                    { 7, "Insurance and Card", null },
                    { 5, "Finance Systems", null },
                    { 4, "Creative QA", null },
                    { 6, "Ford", null },
                    { 2, "Behavioral Science and Innovation", null },
                    { 1, "App Dev", null },
                    { 0, "N/A", null },
                    { 3, "Creative Services", null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Departments_IgniteUserId",
                table: "Departments",
                column: "IgniteUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IgniteUserApplications_FkQuestionToAnswerId",
                table: "IgniteUserApplications",
                column: "FkQuestionToAnswerId",
                unique: true);
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Departments_AspNetUsers_IgniteUserId",
                table: "Departments",
                column: "IgniteUserId",
                principalTable: "AspNetUsers",
                principalColumn: "Id",
